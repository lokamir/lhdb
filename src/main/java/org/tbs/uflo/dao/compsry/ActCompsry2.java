...
@Component
public class ActCompsry2 implements ActionHandler {
	...
	public void handle(ProcessInstance processInstance, Context context) {
		...
		if (StringUtils.isNotEmpty(docid)){
			...
			String sql_fgid = "select account from tbs_approver where title like '%风险控制委员会成员%' or title like '%评审会秘书%'";
			...
			Msgpkt.setTitle("【项目名称："+projname+"】【代偿申请】召开风险管理委员会会议！");
