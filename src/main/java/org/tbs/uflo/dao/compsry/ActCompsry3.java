...
@Component
public class ActCompsry3 implements ActionHandler {
	...
	public void handle(ProcessInstance processInstance, Context context) {
		...
		if (StringUtils.isNotEmpty(docid)){
			...
			//更新状态
			String sql="update tbs_projcompsry set valid=1 where id="+docid+" and proj_id="+projid;
